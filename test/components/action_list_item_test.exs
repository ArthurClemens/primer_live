defmodule PrimerLive.TestComponents.ActionListItemTest do
  ...
  test "Attribute: is_single_select" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             """
             <li class="ActionList-item" role="option"><span class="ActionList-content"><span class="ActionList-item-visual ActionList-item-visual--leading"><div class="FormControl-checkbox-wrap ActionList-item-singleSelectCheckmark"><input checked class="FormControl-checkbox" id="item-1" name="item-1" tabindex="0" type="checkbox" value="true" /></div></span><span class="ActionList-item-label">Item</span></span></li><li class="ActionList-item" role="option"><span class="ActionList-content"><span class="ActionList-item-visual ActionList-item-visual--leading"><div class="FormControl-checkbox-wrap ActionList-item-singleSelectCheckmark"><input class="FormControl-checkbox" id="item-2" name="item-2" tabindex="0" type="checkbox" value="true" /></div></span><span class="ActionList-item-label">Item</span></span></li>
             """
             |> format_html()
  rescue
    e in ExUnit.AssertionError ->
  ...
  test "Attribute: is_multiple_select" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             """
             <li class="ActionList-item" role="option"><span class="ActionList-content"><span class="ActionList-item-visual ActionList-item-visual--leading"><div class="FormControl-checkbox-wrap ActionList-item-multiSelectIcon"><input checked class="FormControl-checkbox" id="item-1" name="item-1" tabindex="0" type="checkbox" value="true" /></div></span><span class="ActionList-item-label">Item</span></span></li><li class="ActionList-item" role="option"><span class="ActionList-content"><span class="ActionList-item-visual ActionList-item-visual--leading"><div class="FormControl-checkbox-wrap ActionList-item-multiSelectIcon"><input class="FormControl-checkbox" id="item-2" name="item-2" tabindex="0" type="checkbox" value="true" /></div></span><span class="ActionList-item-label">Item</span></span></li>
             """
             |> format_html()
  rescue
    e in ExUnit.AssertionError ->
