  ...
  test "Option: classes" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <summary class="button-x" aria-haspopup="true">Label<div class="dropdown-caret caret-x"></div>
             </summary>
  ...
  test "Full menu" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <summary class="btn button-x" aria-haspopup="true"><svg class="octicon" xmlns="http://www.w3.org/2000/svg" width="16"
