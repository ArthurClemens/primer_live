defmodule PrimerLive.Components.TabnavTest do
  ...
  test "Slot: item (various types)" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <a href="#url" aria-current="page" class="tabnav-tab">href link</a>
             <a href="#url" data-phx-link="redirect" data-phx-link-state="push" class="tabnav-tab">navigate link</a>
             <a href="#url" data-phx-link="patch" data-phx-link-state="push" class="tabnav-tab">patch link</a>
             </nav>
             </div>
             """
             |> format_html()
  ...
  test "Slot: item (with various content)" do
    assigns = %{}
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <a href="#url" aria-current="page" class="tabnav-tab">
  ...
  test "Slot: position_end" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <nav class="tabnav-tabs">
             <a href="#url" aria-current="page" class="tabnav-tab">One</a><a href="#url" class="tabnav-tab">Two</a>
             <a href="#url" class="tabnav-tab">Three</a>
             </nav>
             </div>
             """
             |> format_html()
  ...
  test "Slot: position_end, is_extra" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <nav class="tabnav-tabs" aria-label="Tabs">
             <a href="#url" aria-current="page" class="tabnav-tab">One</a>
             <a href="#url" class="tabnav-tab">Two</a><a href="#url" class="tabnav-tab">Three</a>
             </nav>
             </div>
             """
             |> format_html()
  ...
  test "Classes" do
    ...
    assert rendered_to_string(~H"""
           <.tabnav
             ...
             class="my-tabnav"
           >
             <:item href="#url" is_current class="my-tab">
               One
             </:item>
             <:item href="#url">
               Two
           ...
           |> format_html() ==
             ...
             <a href="#url" aria-current="page" class="tabnav-tab tab-x my-tab">One</a>
             <a href="#url" class="tabnav-tab tab-x">Two</a>
             </nav>
             </div>
             """
             |> format_html()
  ...
  test "Extra attributes" do
    ...
    assert rendered_to_string(~H"""
           <.tabnav aria_label="Topics navigation" dir="rtl">
             <:item href="#url" is_current aria-label="View One">
               One
             </:item>
             <:item href="#url">
               Two
           ...
           |> format_html() ==
             ...
             <a href="#url" aria-label="View One" aria-current="page" class="tabnav-tab">One</a>
             <a href="#url" class="tabnav-tab">Two</a>
             </nav>
             </div>
             """
             |> format_html()
