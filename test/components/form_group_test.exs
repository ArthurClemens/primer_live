  ...
  test "Checkboxes" do
    ...
    assert rendered_to_string(~H"""
           ...
           |> format_html() ==
             ...
             <div class="FormControl-checkbox-wrap"><span phx-feedback-for="user_available_for_hire_admin" class="pl-invalid"></span><input name="user[available_for_hire]" type="hidden" value="false" /><input class="FormControl-checkbox" id="user_available_for_hire_admin" invalid=""
             ...
             <div class="FormControl-checkbox-wrap"><span phx-feedback-for="user_available_for_hire_editor" class="pl-invalid"></span><input name="user[available_for_hire]" type="hidden" value="false" /><input class="FormControl-checkbox" id="user_available_for_hire_editor" invalid=""
